...
public class Page03 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_first = findViewById(R.id.page3_btn_1);
        btn_second = findViewById(R.id.page3_btn_2);
        btn_third = findViewById(R.id.page3_btn_3);
        txt_view = findViewById(R.id.page3_textView);
    ...
    private void pageSelected(Button btn){
        if(btn.getId() == this.btn_first.getId()){
            Intent page1 = new Intent(Page03.this, MainActivity.class);
            startActivity(page1);
        } else if (btn.getId() == this.btn_second.getId()) {
            Intent page2 = new Intent(Page03.this, Page01.class);
            startActivity(page2);
        } else if (btn.getId() == this.btn_third.getId()) {
            Intent page3 = new Intent(Page03.this, Page02.class);
            startActivity(page3);
        }
    }
}