...
public class Page01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_first = findViewById(R.id.page1_btn_1);
        btn_second = findViewById(R.id.page1_btn_2);
        btn_third = findViewById(R.id.page1_btn_3);
        txt_view = findViewById(R.id.page1_textView);
        txt_content = findViewById(R.id.page1_txt_content);
    ...
    private void pageSelected(Button btn){
        if(btn.getId() == this.btn_first.getId()){
            Intent page1 = new Intent(Page01.this, MainActivity.class);
            startActivity(page1);
        } else if (btn.getId() == this.btn_second.getId()) {
            Intent page2 = new Intent(Page01.this, Page02.class);
            startActivity(page2);
        } else if (btn.getId() == this.btn_third.getId()) {
            Intent page3 = new Intent(Page01.this, Page03.class);
            startActivity(page3);
        }
    }
